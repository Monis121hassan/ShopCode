...
function Header() {
      ...
      return (
        ...
        <nav className="header">
            <Link to="/">
            <img className="header__logo" src="https://www.pngmart.com/files/12/Shopee-Logo-Transparent-Background.png" alt=" "/>

             </Link>
                <div className="header__search">
                <input type="text" className="header__searchInput" width="100px"/>
                ...
                <div className="header__nav">
                    ...
                    <Link to="/" className="header__link">
                       <div onClick="" className="header__option">
                         ...
                         <span className="header__optionTwo">Account ?</span>
                       </div>
